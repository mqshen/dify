...
const LocaleLayout = async ({
  ...
  const datasetMap: Record<DatasetAttr, string | undefined> = {
    ...
    [DatasetAttr.DATA_REPORT_URL_PREFIX]: process.env.NEXT_PUBLIC_REPORT_URL_PREFIX,
    [DatasetAttr.DATA_REPORT_CALLBACK_URL_PREFIX]: process.env.NEXT_PUBLIC_REPORT_CALLBACK_URL_PREFIX,
